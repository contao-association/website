...
//				break;
	...
	public function generate()
	{
		...
		$return .= '<table cellspacing="0" rel="maxCount['.(($this->maxCount)? $this->maxCount : '0').']" cellpadding="0" id="ctrl_'.$this->strId.'" class="tl_modulewizard multicolumnwizard" summary="MultiColumnWizard">
		<thead>
		<tr>';
		...
		{   
			...
			{       
				$this->import($arrData['options_callback'][0]);
                         ...
                         $strTable = $arrData['options_callback'][0];                  
