...
$GLOBALS['NOTIFICATION_CENTER']['NOTIFICATION_TYPE']['association']['cashctrl'] = [
    ...
    'email_text'           => ['membership_label', 'invoice_number', 'invoice_date', 'invoice_due_days', 'invoice_total', 'payment_status', 'payment_first', 'payment_interval', 'payment_link', 'payment_date', 'payment_total', 'member_*', 'admin_email'],
    'email_html'           => ['membership_label', 'invoice_number', 'invoice_date', 'invoice_due_days', 'invoice_total', 'payment_status', 'payment_first', 'payment_interval', 'payment_link', 'payment_date', 'payment_total', 'member_*', 'admin_email'],
